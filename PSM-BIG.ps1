...
$form.Width = [math]::Round($screenWidth * $targetWidthPercentage)
$form.Height = [math]::Round($screenHeight * $targetHeightPercentage)
...
# Calculate the margins for the RichTextBox control
$margin = [math]::Round(($form.ClientSize.Width - 1500) / 2)

# Output RichTextBox
$richTextBoxOutput = New-Object System.Windows.Forms.RichTextBox
$richTextBoxOutput.Location = New-Object System.Drawing.Point($margin, 870)
$richTextBoxOutput.Size = New-Object System.Drawing.Size(1500, 240)
...
# Calculate the margins and width based on the desired percentage of the form width
$textBoxWidthPercentage = 0.75  # Set your desired relative width percentage
$textBoxMarginsPercentage = (1 - $textBoxWidthPercentage) / 2

# Calculate the control dimensions based on the form dimensions
$textBoxWidth = [math]::Round($form.Width * $textBoxWidthPercentage)
$textBoxMargins = [math]::Round($form.Width * $textBoxMarginsPercentage)

$textBoxScriptsPath.Location = New-Object System.Drawing.Point($textBoxMargins, 7)                              # (X = Right+)(Y = Down-)
$textBoxScriptsPath.Size = New-Object System.Drawing.Size($textBoxWidth, 30)                                    # (W = Wider+)(H = Tall+)
...
$form.Add_Paint({
    ...
    # Calculate the margins and rectangle dimensions
    $margin = 10
    $rectangleHeight = 50
    
    $rectangleWidth = ($form.ClientSize.Width - 20)  
    
    $rectangleX = ($form.ClientSize.Width - $rectangleWidth) / 2  # Centering the rectangle based on form's width
    
    $rectangleY = 35  # Keep the Y coordinate the same
    
    $rectangle = New-Object System.Drawing.Rectangle($rectangleX, $rectangleY, $rectangleWidth, $rectangleHeight)
...
$buttonLoadScripts.Location = New-Object System.Drawing.Point(20, 46) # Increase X = Right, y = Down
...
$labelBackupCounter.Font = New-Object System.Drawing.Font("CoolFont", 12) # You can replace "CoolFont" with the actual font name
$labelBackupCounter.ForeColor = [System.Drawing.Color]::Maroon    
...
$labelBackupCountValue.Location = New-Object System.Drawing.Point(370, 120)  #Increase X = Right, y = Down
$labelBackupCountValue.Size = New-Object System.Drawing.Size(30, 20)         # Increase W = Wider, H = Taller 
$labelBackupCountValue.Font = New-Object System.Drawing.Font("CoolFont", 12) # You can replace "CoolFont" with the actual font name
$labelBackupCountValue.ForeColor = [System.Drawing.Color]::Red
...
$labelScripts.Font = New-Object System.Drawing.Font("CoolFont", 16) # You can replace "CoolFont" with the actual font name
$labelScripts.ForeColor = [System.Drawing.Color]::Maroon
$labelScripts.Text = "|Scripts Listbox|"
$labelScripts.AutoSize = $true
$labelScripts.Location = New-Object System.Drawing.Point(13, 110) # Increase X = Right, y = Down
...
$listboxwidth = $form.Width * .25
$listboxy = $rectangleY + 20


# Calculate dimensions and position
$margin = 20
$widthPercentage = 0.25
$height = ($form.ClientSize.Height - $richTextBoxOutput.Bottom - $margin) * 0.8
$width = $form.Width * $widthPercentage - 2 * $margin
$yPosition = $rectangleY + $rectangleHeight + $margin

$listBoxScripts.Location = New-Object System.Drawing.Point($margin, $yPosition)
$listBoxScripts.Size = New-Object System.Drawing.Size($width, $height)
...
#$listBoxScripts.Size = New-Object System.Drawing.Size(380, 670)   # Increase W = Wider, H = Taller.
...
$listBoxScriptTags.ColumnWidth = 109
$listBoxScriptTags.MultiColumn = $true
$listBoxScriptTags.BackColor = "MintCream"
$listBoxScriptTags.ForeColor = "Black"
$listBoxScriptTags.Font = New-Object System.Drawing.Font("Arial Narrow", 11)  # Change the font family and size her
...
$pictureBox.Location = New-Object Drawing.Point(920, 424)   # Increase X = Right, y = Down
$pictureBox.Size = New-Object Drawing.Size(130, 85)        # Increase W = Wider, H = Taller.
